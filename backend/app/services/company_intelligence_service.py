...
class CompanyIntelligenceService:
    ...
    async def generate_insight(self, lead_id: uuid.UUID, current_user) -> CompanyInsight:
    ...
    async def get_latest_insight(
        self, lead_id: uuid.UUID, current_user
    ) -> CompanyInsight | None:
    ...
    async def list_insights(self, lead_id: uuid.UUID, current_user) -> list[CompanyInsight]:
